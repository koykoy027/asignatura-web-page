...
***********************************************************/	
	...
	//Set Upload directory    
		// C:\wamp64\www\Asignatura Web Page (2)\Main pages\assets\images
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/Asignatura Web Page (2)/Main pages/assets/images/profilePics';
	//Set File name	
...
if (isset($_POST['x'])){
	...
	if($type == 'jpg' || $type == 'jpeg' || $type == 'JPG' || $type == 'JPEG'){	
		...
		$insert_pic_query = mysqli_query($con, "UPDATE users SET profilePic='$result_path' WHERE username='$userLoggedIn'");
