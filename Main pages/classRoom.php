...
<br><br><br><br>
    <div class="user_details cloumn">
        ...
        <form action="" method="POST" class="search__form">
                <input type="text" placeholder='Search posts' autocomplete='off'  id='search-bar' name='searched_text'><button style="background: deepskyblue;" id="search__btn" name="search__btn"><i class="fas fa-search"></i></button>
        </form> 
    ...
    <div class="people_column" style="margin-top:3%;">


       <h4>Instructor</h4><br><center><a style="text-decoration: none;color:#000;" href="<?php echo $teacherName; ?>"><img src='<?php echo $teacherDetails['profilePic'] ?>' width='50%'><br><?php echo $teacherDetails['first_name'] . " " . $teacherDetails['last_name'] ?></a></center>
        <br>
    ...
    <div class="main_column" style="margin-top: 3%;">
        <div id="first">
            <form class="post_form" method="POST">
                <textarea name='post_text' id='post_text_area' placeholder='Announce something to your class'></textarea>
        ...
        <div id="second">
            <form class="assignment_form" method="POST" enctype="multipart/form-data">
                ...
                <textarea name='assignment_text' id='assignment-textarea' placeholder='Announce something to your class'></textarea>
