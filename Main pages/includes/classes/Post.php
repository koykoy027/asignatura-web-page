...
public function loadTeachingClasses()
{
	...
	if (mysqli_num_rows($data_query) > 0) {
		while ($row = mysqli_fetch_array($data_query)) {
			...
			if ($userLoggedIn == $added_by) {
				$delete_teachingClass = "<a href='includes/form_handlers/delete_post.php?createClass_id=$id&courseCode=$code'><input type='button' id='delete_button' value='Delete class'></a>";
			} else {
				$delete_teachingClass = "";
			}

			$str .= "<div class='classBoxes'>
								...
								<br>								
								<hr>
								<span class='lead' id='boxes-span'>$section</span>
								<br>
...
public function loadEnrolledClasses()
{
	...
	if (mysqli_num_rows($data_query) > 0) {
		while ($row = mysqli_fetch_array($data_query)) {
			...
			$delete_EnrolledClass = "<a href='includes/form_handlers/delete_post.php?Enrolled_Student=$this->user&amp;classCode=$code'><input type='button' id='delete_button' value='Leave class'></a>";
			...
			$str .= "<div class='EnrolledclassBoxes'>
					   <div class='topBoxes' style='background:#00b4d8;'>
						   <a href = 'classRoom.php?classCode=$code'><h3>$subject</h3></a>
						   <span>$className</span>
						   <br>
						</div>
					   ...
					   <span class='lead' id='boxes-span'>$added_by</span>
					   <br><br>
...
public function searchPosts($searchedPost){
	...
	if (mysqli_num_rows($query) > 0) {
		while ($row = mysqli_fetch_array($query)) {
			...
			if ($userLoggedIn == $added_by) {
				$deletePost_button = "<a class='delete_button' href='includes/form_handlers/delete_post.php?post_id=$id&amp;classCode=$this->code'><input id='btn-remove' type='button' value='Delete'></a>";
